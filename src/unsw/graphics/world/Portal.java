...
//    
        ...
        Texture portalTerr = new Texture(gl, "res/textures/rock.bmp","bmp", true);
		gl.glBindTexture(GL.GL_TEXTURE_2D, portalTerr.getId());
    }
    ...
    public void display(GL3 gl, CoordFrame3D view) {
    	...
    	CoordFrame3D TFrame = view.translate(getPosition().getX(),getPosition().getY()+.80f ,getPosition().getZ()).translate(0,-0.5f,0).rotateY(90).rotateX(90).scale(1, 1, 1);
//     
